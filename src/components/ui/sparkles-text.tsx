...
interface SparklesTextProps {
  text: string;
  as?: "h1" | "h2" | "h3" | "h4" | "h5" | "h6" | "button" | "span" | "p";
  className?: string;
...
export function SparklesText({
  ...
  return (
    ...
    >
      ...
      <Tag className={cn(
        "relative z-10 bg-gradient-to-r from-dark-rose via-[#e66c8e] to-dark-rose bg-clip-text text-transparent py-1",
        className
      )}>
        {text}
      </Tag>
...
function Sparkle({ sparkle, duration }: SparkleProps) {
  return (
    <motion.div
      key={sparkle.id}
      initial={{
